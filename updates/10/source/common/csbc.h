...
!       issdic_pref = sea surface concentration of preformed dic (umol cm-3)
!       idicflx_pref   = sea surface flux of preformed carbon (umol cm-2 s-1)
!       issdic_sat    = sea surface concentration of saturated dic (umol cm-3)
!       idicflx_sat   = sea surface flux of saturated dic (umol cm-2 s-1)
!	issc_soft    = sea surface concentration of regenerated carbon from soft tissue (umol cm-2 s-1)
!	issc_caco3   = sea surface concentration of regenerated carbon from biominerals (umol cm-2 s-1)
!	ic_softflx   = sea surface flux of regenerated carbon from soft tissue (umol cm-2 s-1)
!	ic_caco3flx  = sea surface flux of regenerated carbon from biominerals (umol cm-2 s-1)
!       issdic13_pref = sea surface concentration of preformed dic13 (umol cm-3)
!       idic13flx_pref   = sea surface flux of preformed carbon13 (umol cm-2 s-1)
!       issdic13_sat    = sea surface concentration of saturated dic13 (umol cm-3)
!       idic13flx_sat   = sea surface flux of saturated dic13 (umol cm-2 s-1)
!       issc13_soft    = sea surface concentration of regenerated carbon13 from soft tissue (umol cm-2 s-1)
!       ic13_softflx   = sea surface flux of regenerated carbon13 from soft tissue (umol cm-2 s-1)
!       issdic13  = sea surface concentration of dic13 (umol cm-3)
!       idic13flx = sea surface flux of c13 (umol cm-2 s-1)
!       issc13_caco3    = sea surface concentration of regenerated carbon13 from biominerals (umol cm-2 s-1)
!       ic13_caco3flx   = sea surface flux of regenerated carbon13 from biominerals (umol cm-2 s-1)
...
!       issphyt_phos = sea surface concentration of phytoplankton_phos (nmol P cm-3)
!       iphytflx  = sea surface flux of phytoplankton (nmol P cm-2 s-1)
!       iphytflx_phos  = sea surface flux of phytoplankton_phos (nmol P cm-2 s-1)
...
!       issdetr_phos   = sea surface concentration of detritus_phos (nmol P cm-3)
!       idetrflx_phos  = sea surface flux of detritus_phos (nmol P cm-2 s-1)
...
!SPKPATH
!       issprotac = sea surface concentration of Pa-231 (fmol m-3)
!       iprotacflx = sea surface flux of Pa-231 (XXXX)
!       issthor = sea surface concentration of Th-230 (fmol m-3)
!       ithorflx = sea surface flux of Th-230 (XXXX)
!       idustadep = sea surface flux of dust (kg m-2 s-1)
...
#  if defined O_mobi
     &                  + 2 ! ssdic_pref, dicflx_pref
     &			+ 2 ! ssc_soft, c_softflx
#   if defined O_mobi_caco3
     &			+ 2 ! ssc_caco3, c_caco3flx
#   endif
#  endif  !! O_mobi
     &		 	+ 2 ! ssdic_sat, dicflx_sat
#  if defined O_carbon_13
#   if defined O_mobi
     &                  + 2 ! ssdic13_pref, dic13flx_pref
     &                  + 2 ! ssc13_soft, c13_softflx
#   endif
     &                  + 2 ! ssdic13_sat, dic13flx_sat
#   if defined O_mobi
#    if defined O_mobi_caco3
     &                  + 2 ! ssc13_caoc3, c13_caco3flx
#    endif !!O_mobi_caco3
#   endif  !!O_mobi
#  endif !!O_carbon_13
...
# if !defined O_mobi_no_vflux
     ...
     &                  + 4 ! ssphyt_phos, phytflx_phos, ssdetr_phos, detrflx_phos
...
# if defined O_PaTh_vflux
     &                  + 4 ! ssprotac, protacflx, ssthor, thorflx
# endif
     &                  + 1 ! dustadep
#endif
#if defined O_mtlm
...
# endif
     ...
     &                     )
      ...
      integer issdic_pref, idicflx_pref, issdic_sat, idicflx_sat
      integer issc_soft, ic_softflx, issc_caco3, ic_caco3flx
      integer issdic13_pref, idic13flx_pref
      integer issc13_soft, ic13_softflx
      integer issdic13_sat, idic13flx_sat
      integer issc13_caco3, ic13_caco3flx
      integer io2flx, isspo4, ipo4flx, issphyt, iphytflx, isszoop
      integer issphyt_phos, iphytflx_phos, issdetr_phos, idetrflx_phos
      ...
      integer issprotac, iprotacflx, issthor, ithorflx
      integer idustadep
      ...
      common /csbc_i/ issdic_pref, idicflx_pref, issdic_sat, idicflx_sat
      common /csbc_i/ issc_soft, ic_softflx, issc_caco3, ic_caco3flx
      common /csbc_i/ issdic13_pref, idic13flx_pref
      common /csbc_i/ issc13_soft, ic13_softflx
      common /csbc_i/ issdic13_sat, idic13flx_sat
      common /csbc_i/ issc13_caco3, ic13_caco3flx
      common /csbc_i/ ialkflx, isso2, io2flx, isspo4, ipo4flx, issphyt
      common /csbc_i/ iphytflx, isszoop, izoopflx, issdetr, idetrflx
      common /csbc_i/ issphyt_phos, iphytflx_phos
      common /csbc_i/ issdetr_phos, idetrflx_phos
      ...
      common /csbc_i/ issprotac, iprotacflx, issthor, ithorflx
      common /csbc_i/ idustadep
