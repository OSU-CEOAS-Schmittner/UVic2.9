...
# if defined O_PaTh && defined O_save_PaTh_diagnostics
      real ta_protacd, ta_protacb, ta_thord, ta_thorb
      real ta_protac_bflux, ta_thor_bflux
      common /ta_path/ ta_protacd(imt,km,jmt), ta_protacb(imt,km,jmt)
      common /ta_path/ ta_thord(imt,km,jmt), ta_thorb(imt,km,jmt)
      common /ta_path/ ta_protac_bflux(imt,jmt), ta_thor_bflux(imt,jmt)
# endif
#endif
