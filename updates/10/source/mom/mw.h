...
!       idic_pref   = index for preformed dissolved inorganic carbon
!	idic_sat = index for saturated dissolved inorganic carbon
!       ic_soft  = index for carbon regenerated from soft tissue 
!	ic_caco3 = index for carbon regenerated from biominerals
!       idic13_pref   = index for preformed dissolved inorganic carbon13
!       idic13_sat = index for saturated dissolved inorganic carbon13
!       ic13_soft  = index for carbon13 regenerated from soft tissue
!       ic13_caco3  = index for carbon13 regenerated from biominerals
!       idic13 = index for carbon 13
!       ic14   = index for carbon 14
!       icfc11 = index for cfc11
!       icfc12 = index for cfc12
!SPKPATH
!       iprotac = index for Pa-231
!       ithor = index for Th-230
!       ialk   = index for alkalinity
!       ipo4   = index for phosphate
!       idop   = index for DOP		       
!       iphyt  = index for phytoplankton
!       iphyt_phos  = index for phytoplankton_phos
!       izoop  = index for zooplankton
!       idetr  = index for detritus
!       idetr_phos  = index for detritus_phos
...
!       iopl   = index for opal
      ...
      integer iphyt_phos, idetr_phos, idic_pref, ic_soft, ic_caco3
      integer idfe, idetrfe, idiatc13, icaco3c13, idic_sat
      integer idic13_pref, ic13_soft, idic13_sat, ic13_caco3
      integer idin15, idon15, iphytn15, izoopn15, idetrn15, idiazn15
      integer idic13, idoc13, iphytc13, izoopc13, idetrc13, idiazc13
!SPKPATH
      integer iprotac, ithor
      
      common /mw_i/ itemp, isalt, idic, ic14, icfc11, icfc12, ialk
      common /mw_i/ ipo4, iphyt, izoop, idetr, io2, ino3, idiaz
      common /mw_i/ iphyt_phos, idetr_phos, idic_pref, idic_sat
      common /mw_i/ ic_soft, ic_caco3
      common /mw_i/ idic13_pref, ic13_soft, idic13_sat, ic13_caco3
...
!SPKPATH
      common /mw_i/ iprotac, ithor
		       
!     indicies for ocean tracer source array
!       istemp  = index for temperature
!       issalt  = index for salinity
!       isdic   = index for carbon
!       isdic_pref   = index for preformed carbon
!	isdic_sat = index for saturated carbon
!	isc_soft = index for carbon regenerated from soft tissue
!	isc_caco3 = index for carbon regenerated from biominerals
!       isdic13_pref   = index for preformed carbon13
!       isdic13_sat = index for saturated carbon13
!       isc13_soft = index for carbon13 regenerated from soft tissue
!       isc13_caco3  = index for carbon13 regenerated from biominerals
!       isc14   = index for carbon 14
!       isalk   = index for alkalinity
!       ispo4   = index for phosphate
!       isdop   = index for DOP
!       isphyt  = index for phytoplankton
!       isphyt_phos = index for phytoplankton_phos
!       iszoop  = index for zooplankton
!       isdetr  = index for detritus
!       isdetr_phos  = index for detritus_phos
...
!SPKPATH
!       isprotac = index for Pa-231
!       isthor = index for Th-230
...
!       mapst   = map for ocean tracer source names
      ...
      integer isphyt_phos, isdetr_phos, isdic_pref, isc_soft
      integer isc_caco3, isdic_sat
      integer isdic13_pref, isc13_soft, isdic13_sat, isc13_caco3
      ...
      integer isdiazc13
!SPKPATH
      integer isprotac, isthor
      
      common /mw_i/ istemp, issalt, isdic, isc14,isalk, ispo4, isphyt
      common /mw_i/ isphyt_phos, isdetr_phos, isdic_pref
      common /mw_i/ isc_soft, isc_caco3, isdic_sat
      common /mw_i/ isdic13_pref, isc13_soft, isdic13_sat
      common /mw_i/ isc13_caco3
