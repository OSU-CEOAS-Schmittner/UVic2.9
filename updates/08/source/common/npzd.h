...
# if defined O_kk_si
      real sipr0, ropk, dopal, si_sol, si_h_sol, si_dis
      real globalsilwflx, sildustflux, ws0, rivsil
      real prop, expo_op, op_diss, bsi   
      real si_hydr
      common /npzd_r/ sipr0, ropk(km), dopal, si_sol, si_h_sol, si_dis
      common /npzd_r/ globalsilwflx, sildustflux, ws0, rivsil
      common /npzd_r/ prop, expo_op, op_diss, bsi(km)
...
#  endif
# if defined O_kk_diat
      common /npzd_r/ rnpp_Diat(kpzd)
      common /npzd_r/ rgraz_Diat(kpzd)
      common /npzd_r/ rmorp_Diat(kpzd)
      common /npzd_r/ rmorpt_Diat(kpzd)
# endif
